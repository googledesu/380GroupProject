...
public class TicketServiceImpl implements TicketService {
    ...
    //to add comments by connecting the old comment with the new comment
    @Override
    @Transactional(rollbackFor = TicketNotFound.class)
    public void addComment(long id,
        ...
        String oldComment = updatedTicket.getComment();     
        String newComment =oldComment+" Comments: "+comment+"  ";
        updatedTicket.setComment(newComment);
        ticketRepo.save(updatedTicket);

    }
    //delete comment by setting the comment to empty string
    @Override
    @Transactional(rollbackFor = TicketNotFound.class)
    public void deleteComment(long id)
        ...
        updatedTicket.setComment(deleteComment);
        ticketRepo.save(updatedTicket);
